...
2. Запустить проект `make prod_up`
3. Сайт на адресе `http://127.0.0.1:8000`
4. Останов проекта` make prod_down`
...
1. Логирование 
2. Обработка ошибок 
3. Документация к основным методам
4. ~~Хранение секретов~~
5. Тесты 
6. Типы 
7. Линтеры, чеккеры
8. ~~Сделать логирование базы~~
9. Сделать авторазворачивание базы из бекапа 
10. Фронт 
11. Сваггер/openapi
12. Изменить структуру проекта для лучшей сборки в docker-compose
